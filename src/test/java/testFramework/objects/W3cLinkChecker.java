...
public class W3cLinkChecker {
    ...
    public Boolean fileValidates() {
        ...
        if (Context.defaultDriver.findElement(By.tagName("h3")).getText().toLowerCase().contains("broken links")) {
            ...
            Actor.writeToHtmlReport(Context.defaultDriver.findElement(By.tagName("dl")).getAttribute("innerHTML"));
            return false;
        }
        ...
        Actor.writeToHtmlReport("Failed to find evidence of success (a P saying just that)");
        return false;
    }
}